...
SECRET_KEY = 'django-insecure-hacw9=8%@x#*6g5kdr6fy)8@ynqsl*_#z8py%i!tto*ig7k)5i'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
CORS_ALLOW_ALL_ORIGINS = True  # Allows all requests (Not recommended for production)
